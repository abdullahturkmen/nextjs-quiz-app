...
export default function SplashScreen() {
  ...
  return (
    <main className="grid h-screen place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div>
        <h1 className="text-3xl font-semibold text-[var(--primary-color)] text-center mb-8 absolute top-[32px] left-[50%]" style={{transform: 'translate(-50%, 0)'}}>
          QuizApp
        </h1>
        ...
        <div className="mt-10 flex items-center justify-center gap-x-6">
          <Link
            href="/CounterScreen"
            className="rounded-xl bg-[var(--main-color)] px-3.5 py-5 text-sm text-white"
          >
            Let's Get Started
          </Link>
        </div>
